...
parser.add_argument('--end_epoch', type=int, default=2, help='epoch number to end training')
...
parser.add_argument('--save_interval', type=int, default=1, help='interval of saving model checkpoints')
...
def train_model(cs_ratio, model, log_file_name, model_dir):
    ...
    for epoch_i in range(start_epoch + 1, end_epoch + 1):
        ...
        for data in calib_loader:
            ...
            optimizer.zero_grad()
            scaler.scale(loss_discrepancy).backward()
